...
export default function GuestDemoPage({ initialLang }: GuestDemoPageProps) {
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">
                        {currentLanguage === 'tr' ? 'Aktif Duyurular' : currentLanguage === 'de' ? 'Aktive Ankündigungen' : 'Active Announcements'}
                    </h3>
                    <AnnouncementBanner />
                </div>
