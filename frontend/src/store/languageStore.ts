...
export const translations: Record<string, Translations> = {
  tr: {
    ...
    'qrMenuSystem': 'Gelişmiş QR Sipariş',
    ...
    'kitchenStatTitle': 'Kampanya & İleri QR Sipariş',
    'kitchenStatDesc': 'Gelişmiş stok kontrolü ve personel yönetimi ile restoran ve oda servis hızınızı 2 katına çıkarın.',
    ...
    'mgmtNoTechRequired': 'Personel yönetimi ve stok takibi ile restoran/kafe kullanımını maksimuma çıkarın.',
    'mgmtMenuUpdate': 'Anlık Menü & Fiyat Güncelleme',
    'mgmtStockHide': 'Oda Servisi & Stok Yönetimi',
    ...
    'waiterCallDesc': 'Misafirleriniz resepsiyonu aramadan havlu, temizlik veya QR üzerinden oda servisi taleplerini iletsin.',
    'waiterCallFooter': 'Hizmet hızını artırırken resepsiyon yükünü azaltın.',
    'zeroErrorSectionTitle': 'OPERASYONEL HIZ',
    'qrToKitchenTitle': 'QR Siparişten Birime Kesintisiz İletişim',
    'qrToKitchenDesc': 'Siparişler ve talepler doğrudan ilgili departmana (Mutfak, Kat Hizmetleri vb.) hatasız aktarılır.',
    'zeroErrorList1': 'Hızlı Erişim',
    'zeroErrorList2': 'Stok Kontrolü',
    ...
    'adIncomeDesc': 'Menüdeki premium reklam alanları ve gelişmiş QR sipariş sistemiyle otel içi karları maksimize edin.',
    'adTag1': 'Sipariş', 'adTag2': 'Gelir', 'adTag3': 'Operasyon', 'adTag4': 'Ciro',
    'noChangeTitle': 'KOLAY ENTEGRASYON',
    'noChangeSubtitle': 'Altyapı Yatırımı Gerektirmez',
    'noChangeDesc': 'Mevcut otel düzeninizi değiştirmeden, sadece QR kodlarla restoran ve oda operasyonunu dijitalleştirin.',
    ...
    'planProFeat1': 'Gelişmiş QR Sipariş & Stok',
    ...
    'demoModalTitle': 'DEMO TALEBİ',
    'demoModalDesc': 'Lütfen aşağıdaki formu doldurun; ekibimiz canlı demo planlamak için en kısa sürede sizinle iletişime geçecektir.',
    'demoModalNameLabel': 'Ad Soyad',
    'demoModalEmailLabel': 'E-posta Adresi',
    'demoModalHotelLabel': 'Otel / İşletme Adı',
    'demoModalSubmit': 'TALEBİ GÖNDER',
    'demoModalSuccessTitle': 'Teşekkürler!',
    'demoModalSuccessDesc': 'Talebiniz alındı. Ekibimiz 24 saat içinde sizinle iletişime geçecektir.',
  ...
  en: {
    ...
    'qrMenuSystem': 'Advanced QR Ordering',
    ...
    'kitchenStatTitle': 'Campaign & Advanced QR Ordering',
    'kitchenStatDesc': 'Double your restaurant and room service speed with advanced stock control and staff management.',
    ...
    'mgmtNoTechRequired': 'Maximize restaurant/cafe usage with staff management and stock tracking.',
    'mgmtMenuUpdate': 'Instant Menu & Price Updates',
    'mgmtStockHide': 'Room Service & Stock Management',
    ...
    'waiterCallDesc': 'Let guests send towel, cleaning, or room service requests via QR without calling reception.',
    'waiterCallFooter': 'Reduce reception load while increasing service speed.',
    'zeroErrorSectionTitle': 'OPERATIONAL SPEED',
    'qrToKitchenTitle': 'Seamless Communication from QR Order',
    'qrToKitchenDesc': 'Orders and requests are transferred directly to the relevant department (Kitchen, Housekeeping, etc.) without errors.',
    'zeroErrorList1': 'Fast Access',
    'zeroErrorList2': 'Stock Control',
    ...
    'adIncomeDesc': 'Maximize in-hotel profits with premium ad spaces and an advanced QR ordering system.',
    'adTag1': 'Order', 'adTag2': 'Revenue', 'adTag3': 'Operation', 'adTag4': 'Profit',
    'noChangeTitle': 'EASY INTEGRATION',
    'noChangeSubtitle': 'No Infra Investment Needed',
    'noChangeDesc': 'Digitize restaurant and room operations with just QR codes, without changing your current hotel layout.',
    ...
    'planProFeat1': 'Advanced QR Ordering & Stock',
    ...
    'demoModalTitle': 'DEMO REQUEST',
    'demoModalDesc': 'Please fill out the form below and our team will contact you shortly to schedule a live demo.',
    'demoModalNameLabel': 'Full Name',
    'demoModalEmailLabel': 'Email Address',
    'demoModalHotelLabel': 'Hotel / Business Name',
    'demoModalSubmit': 'SEND REQUEST',
    'demoModalSuccessTitle': 'Thank You!',
    'demoModalSuccessDesc': 'Your request has been received. Our team will contact you within 24 hours.',
  ...
  de: {
    ...
    // Premium Landing Page
    'metaTitle': 'RoomXQR - Digitale Transformation & Effizienz für Hotels',
    'heroBadge': 'INTEGRIERTE HOTEL-MANAGEMENT-PLATTFORM',
    'heroTitle1': 'Gästeerlebnis verbessern',
    'heroTitle2': '& Ihren Umsatz steigern',
    'heroTitle3': 'Volle Kontrolle über ein Panel',
    'heroSubtitle1': 'Viel mehr als ein QR-Menü. Lassen Sie Ihre Gäste alle Wünsche senden, ohne die Rezeption anzurufen.',
    'heroSubtitle2': 'Rezeptionslast reduzieren, Rentabilität durch Kampagnen und Anzeigen steigern.',
    'requestDemo': 'Demo anfordern',
    'startNow': 'Jetzt starten',
    'premiumServicesBadge': 'VORTEILE FÜR IHR HOTEL',
    'premiumServices': 'Warum RoomXQR?',
    'qrMenuSystem': 'Erweiterte QR-Bestellung',
    'orderManagement': 'Ein-Klick-Anfragen',
    'aiTitle': 'Mehrsprachen-Unterstützung',
    'detailedReporting': 'Verkaufs- & Analysetools',
    'multiLangTitle': 'Kampagnen & Ankündigungen',
    'marketingAdsTitle': 'Entlastung der Rezeption',
    'allInOneTitle': 'Zusatzumsatz-Modell',
    'support247': '24/7 Technischer Support',
    'valPropDigital': 'Lösung zur Reduzierung der Belastung',
    'valPropSpeed': 'Telefonaufkommen sinkt deutlich',
    'valPropSatisfy': 'Gästewünsche sofort übermittelt',
    'valPropProfit': 'Umsatz und Personaleffizienz steigen',
    'valPropTrust': 'DSGVO-konforme sichere Infra',
    'adIncomeTitle': 'ZUSATZEINNAHMEN CHANCE',
    'caseStudyBadge': 'EFFIZIENZ-ANALYSE',
    'customersSuccessTitle': 'Spürbare Vorteile für Ihr Hotel',
    'customersSuccessDesc': 'Hotels, die RoomXQR nutzen, verzeichnen eine Reduzierung der Kosten um 30%, während die Gästebindung um 40% steigt.',
    'valPropStaff': 'Schnellerer Service mit weniger Personal',
    'examineFeature': 'Funktionen prüfen',
    'satisfiedClientsLabel': 'ZUFRIEDENE HOTELS',
    'averageGrowthLabel': 'OPERATIVE GESCHWINDIGKEIT',
    'marketingSectionTitle': 'Marketing- & Zusatzumsatz-Power',
    'learnMore': 'Mehr erfahren',
    'kitchenStatTitle': 'Kampagnen & Erweiterte QR-Bestellung',
    'kitchenStatDesc': 'Verdoppeln Sie die Geschwindigkeit von Restaurant und Zimmerservice mit Bestands- und Personalmanagement.',
    'splitPaymentTitle': 'Werbeflächen',
    'splitPaymentDesc': 'Mühelose Zusatzeinnahmen durch Tourismus- und Transferanzeigen generieren.',
    'socialGrowthTitle': 'Social Media & Reputation',
    'socialGrowthDesc': 'Steigern Sie Ihre Google- und TripAdvisor-Bewertungen organisch durch Umfragen.',
    'multiBranchTitle': 'Multi-Filialen & Ketten-Management',
    'multiBranchDesc': 'Verwalten Sie alle Ihre Standorte einfach über ein zentrales Hub.',
    'aiDesc': 'Intelligentes Routing-System, das die Rezeption spürbar entlastet.',
    'mgmtControlTitle': 'MANAGEMENT & KONTROLLE',
    'mgmtTitle': 'Personaleffizienz, Volle Kontrolle',
    'mgmtNoTechRequired': 'Maximieren Sie die Auslastung von Restaurant/Café durch Personal- und Bestandsverwaltung.',
    'mgmtMenuUpdate': 'Sofortige Menü- & Preis-Updates',
    'mgmtStockHide': 'Zimmerservice- & Bestandsverwaltung',
    'mgmtCampaignDrive': 'Promotions & Service-Highlights',
    'mgmtAnnounceDirect': 'Gruppen-Ankündigungssystem',
    'waiterCallMainTitle': 'DIGITALER CONCIERGE',
    'waiterCallTitle': 'Nahtloser Service für Ihre Gäste',
    'waiterCallDesc': 'Gäste senden Anfragen für Handtücher, Reinigung oder Zimmerservice direkt per QR.',
    'waiterCallFooter': 'Servicegeschwindigkeit erhöhen, Rezeptionslast senken.',
    'zeroErrorSectionTitle': 'OPERATIVE GESCHWINDIGKEIT',
    'qrToKitchenTitle': 'Nahtlose Kommunikation ab QR-Bestellung',
    'qrToKitchenDesc': 'Bestellungen und Anfragen wandern fehlerfrei direkt in die richtige Abteilung (Küche, Hauswirtschaft etc.).',
    'zeroErrorList1': 'Schneller Zugriff',
    'zeroErrorList2': 'Lagerkontrolle',
    'zeroErrorList3': 'Sofort-Benachrichtigung',
    'zeroErrorList4': 'Effiziente Lösung',
    'passiveIncomeLabel': 'WERBE-EINNAHMEN',
    'premiumSpaceLabel': 'INTELLIGENTE ANALYSE',
    'adIncomeSubtitle': 'Umsatzwachstum durch Marketingflächen',
    'adIncomeDesc': 'Maximieren Sie die Hotelgewinne mit Premium-Werbeflächen und einem fortschrittlichen QR-Bestellsystem.',
    'adTag1': 'Bestellung', 'adTag2': 'Umsatz', 'adTag3': 'Operation', 'adTag4': 'Gewinn',
    'noChangeTitle': 'EINFACHE INTEGRATION',
    'noChangeSubtitle': 'Keine Investition nötig',
    'noChangeDesc': 'Digitalisieren Sie Restaurant- und Zimmerservice mit QR-Codes, ohne das Hotel-Layout zu ändern.',
    'noChangeFooter': 'Der effizienteste Hotel-Management-Assistent.',
    'pricingBadge': 'PREISE',
    'pricingTitle': 'Jetzt mit flexiblen Plänen starten',
    'devTeamPromise': 'Unser Team begleitet Sie bei Einrichtung und Schulung.',
    'annualGift': '2 MONATE GRATIS BEI JÄHRLICHER ZAHLUNG',
    'planBasicTitle': 'BOUTIQUE',
    'planBasicPrice': '499',
    'planBasicDesc': 'Basispaket für kleine Hotels und Boutique-Betriebe.',
    'planBasicFeat1': 'QR-Informationssystem',
    'planBasicFeat2': 'Basis-Anfragenmanagement',
    'planBasicFeat3': 'Standard-Support',
    'planProTitle': 'PROFESSIONELL',
    'planProPrice': '999',
    'planProDesc': 'Für mittlere Hotels, Fokus auf Effizienz und Umsatz.',
    'planProFeat1': 'Erweiterte QR-Bestellung & Lager',
    'planProFeat2': 'Umfragen & Auto-Anzeigen',
    'planProFeat3': '24/7 Prioritäts-Support',
    'planEntTitle': 'ENTERPRISE',
    'planEntPrice': 'Individuell',
    'planEntDesc': 'Komplettlösung für große Hotelketten.',
    'planEntFeat1': 'Zentrale Filialverwaltung',
    'planEntFeat2': 'Eigene Integrationen & API',
    'planEntFeat3': 'Eigener Account Manager',
    'branchDiscountNote': 'Sonderpreise je nach Anzahl der Standorte.',
    'refundNote': '14 Tage Zufriedenheitsgarantie',
    'roiTitle': 'Effizienzgewinn',
    'roiGrowth': '+35%',
    'roiGrowthSub': 'UMSATZWACHSTUM',
    'roiEfficiency': '50%',
    'roiEfficiencySub': 'WENIGER TELEFONATE',
    'roiNote': 'System amortisiert sich sofort durch Zeitgewinn.',
    'instantSetupTitle': 'Schneller Startprozess',
    'instantSetupDesc': 'Hotel-Infos hochladen, QR-Codes verteilen und Effizienz steigern.',
    'referralProgramTitle': 'PARTNERSCHAFT',
    'referralPromoLine': 'Empfehlen Sie uns weiter!',
    'referralProgramDesc': 'Erhalten Sie Rabatte für jedes Hotel, dem Sie RoomXQR empfehlen.',
    'referralFaqQ': 'Wie funktioniert das Empfehlungsprogramm?',
    'referralFaqA': 'Rabatte auf Ihr Jahresabo für jeden neuen Kunden, den Sie bringen.',
    'faq': 'FAQ',
    'faqDesc': 'Fragen zu Hotelmanagement und RoomXQR.',
    'faq1Q': 'Wie erleichtert das System den Betrieb?',
    'faq1A': 'Gäste senden Anfragen per QR, was das Telefonaufkommen um 50% reduziert.',
    'faq2Q': 'Wie lange dauert Einrichtung und Schulung?',
    'faq2A': 'Das System ist sehr intuitiv; 15 Minuten Einweisung reichen für das Personal.',
    'faq3Q': 'Sind unsere Daten sicher?',
    'faq3A': 'Ja, vollkommen sicher auf Hochsicherheitsservern gemäß DSGVO.',
    'faq4Q': 'Welche Hotel-Sprachen werden unterstützt?',
    'faq4A': 'Gäste können das System in 9 Sprachen (TR, EN, DE, FR etc.) nutzen.',
    'faq5Q': 'Gibt es technischen Support?',
    'faq5A': 'Ja, wir bieten 24/7 Live-Support für einen reibungslosen Hotelbetrieb.',
    'faq6Q': 'Kann ich das Jahresabo jederzeit kündigen?',
    'faq6A': 'Ja, volle Rückerstattung in den ersten 14 Tagen oder Kündigung zum Monatsende.',
    'faq7Q': 'Aktualisieren wir Kampagnen selbst?',
    'faq7A': 'Ja, über das einfache Panel können Sie alles in Sekunden selbst anpassen.',
    'faq8Q': 'Wird die Abteilungsgeschwindigkeit gemessen?',
    'faq8A': 'Ja, Sie sehen Berichte zur Bearbeitungszeit und Gästezufriedenheit.',
    'contactUs': 'KONTAKT',
    'footerSlogan': 'Ihr Partner für digitale Hotelabläufe und glückliche Gäste.',
    'legalLinkSection': 'RECHTLICHES',
    'privacyPolicy': 'Datenschutzerklärung',
    'termsOfService': 'Nutzungsbedingungen',
    'legalInfo': 'Impressum',
    'demoModalTitle': 'DEMO-ANFRAGE',
    'demoModalDesc': 'Bitte füllen Sie das folgende Formular aus; unser Team wird Sie in Kürze kontaktieren, um eine Live-Demo zu vereinbaren.',
    'demoModalNameLabel': 'Vor- und Nachname',
    'demoModalEmailLabel': 'E-Mail-Adresse',
    'demoModalHotelLabel': 'Hotel- / Betriebsname',
    'demoModalSubmit': 'ANFRAGE SENDEN',
    'demoModalSuccessTitle': 'Danke!',
    'demoModalSuccessDesc': 'Ihre Anfrage wurde empfangen. Unser Team wird Sie innerhalb von 24 Stunden kontaktieren.',
    'demoModalClose': 'SCHLIESSEN',
  },
