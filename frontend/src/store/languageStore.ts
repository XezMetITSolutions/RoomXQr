...
export const translations: Record<string, Translations> = {
  tr: {
    ...
    'metaTitle': 'RoomXQR - Otelinizde Dijital Dönüşüm',
    'heroBadge': 'YENİ NESİL OTEL ÇÖZÜMÜ',
    'heroTitle1': 'Otelinizde',
    'heroTitle2': 'Dijital Dönüşüm',
    'heroTitle3': 'QR ile Anında Hizmet',
    'heroSubtitle1': 'Misafir memnuniyetini ve verimliliği RoomXQR ile artırın.',
    'heroSubtitle2': 'QR menü, sipariş, istekler ve akıllı yönetim tek platformda.',
    'requestDemo': 'Demo Talep Et',
    'startNow': 'Hemen Başla',
    'premiumServicesBadge': 'PREMİUM ÖZELLİKLER',
    'premiumServices': 'Modern Oteller İçin Güçlü Özellikler',
    'qrMenuSystem': 'QR Menü & Sipariş',
    'orderManagement': 'Sipariş Yönetimi',
    'aiTitle': 'AI Destekli Görseller',
    'detailedReporting': 'Detaylı Analiz & Rapor',
    'multiLangTitle': '9+ Dil Desteği',
    'marketingAdsTitle': 'Pazarlama & Reklam',
    'allInOneTitle': 'Hepsi Bir Arada Panel',
    'support247': '7/24 Teknik Destek',
    'valPropDigital': 'Tamamen dijital süreç',
    'valPropSpeed': '%60 daha hızlı servis',
    'valPropSatisfy': 'Mutlu misafirler',
    'valPropProfit': 'Artan ciro & kar',
    'valPropTrust': 'Güvenilir altyapı',
    'adIncomeTitle': 'EK GELİR FIRSATI',
    'caseStudyBadge': 'BAŞARI HİKAYELERİ',
    'customersSuccessTitle': 'Misafirleriniz İçin Kusursuz Deneyim',
    'customersSuccessDesc': 'RoomXQR kullanan otellerde misafir memnuniyeti %45 artarken, personel yükü %40 azalıyor.',
    'valPropStaff': 'Verimli Personel',
    'examineFeature': 'Özellikleri İncele',
    'satisfiedClientsLabel': 'MUTLU MİSAFİRLER',
    'averageGrowthLabel': 'ORTALAMA BÜYÜME',
    'marketingSectionTitle': 'Pazarlama ve Satış Gücü',
    'learnMore': 'Daha Fazla Bilgi',
    'kitchenStatTitle': 'Mutfak Entegrasyonu',
    'kitchenStatDesc': 'Siparişler anında mutfağa düşer, hatalar sıfıra iner.',
    'splitPaymentTitle': 'Hızlı Ödeme Çözümleri',
    'splitPaymentDesc': 'Misafirler hesaplarını kolayca ödeyebilir veya oda hesabına yazdırabilir.',
    'socialGrowthTitle': 'Sosyal Medya Büyümesi',
    'socialGrowthDesc': 'Konaklama sonrası anketlerle TripAdvisor ve Google puanlarınızı artırın.',
    'multiBranchTitle': 'Çoklu Şube Yönetimi',
    'multiBranchDesc': 'Tüm otellerinizi tek bir merkezden kolayca yönetin.',
    'aiDesc': 'Yapay zeka ile menülerinizi otomatik olarak optimize edin.',
    'mgmtControlTitle': 'YÖNETİM & KONTROL',
    'mgmtTitle': 'Kolay Kullanım, Tam Kontrol',
    'mgmtNoTechRequired': 'Teknik bilgi gerektirmez, hemen kullanmaya başlayın.',
    'mgmtMenuUpdate': 'Anlık Menü Güncelleme',
    'mgmtStockHide': 'Tükenen Ürünü Gizleme',
    'mgmtCampaignDrive': 'Kampanya Yönetimi',
    'mgmtAnnounceDirect': 'Anlık Duyuru Gönderimi',
    'waiterCallMainTitle': 'GARSON ÇAĞIRMA',
    'waiterCallTitle': 'Tek Tıkla Garson Çağır',
    'waiterCallDesc': 'Misafirleriniz ihtiyacı olduğunda garsonu masasına/odasına çağırabilir.',
    'waiterCallFooter': 'Hizmet kalitesini en üst seviyeye taşıyın.',
    'zeroErrorSectionTitle': 'SIFIR HATA POLİTİKASI',
    'qrToKitchenTitle': 'QR\'dan Mutfağa Kesintisiz İletişim',
    'qrToKitchenDesc': 'Siparişler Manuel hata payı olmadan doğrudan mutfağa aktarılır.',
    'zeroErrorList1': 'Hızlı Tarama',
    'zeroErrorList2': 'Doğru Seçim',
    'zeroErrorList3': 'Anlık Gönderim',
    'zeroErrorList4': 'Hızlı Servis',
    'passiveIncomeLabel': 'PASİF GELİR',
    'premiumSpaceLabel': 'PREMİUM REKLAM',
    'adIncomeSubtitle': 'Reklam Alanları ile Ek Gelir',
    'adIncomeDesc': 'Menü içerisindeki reklam alanları ile otel içi veya dışı reklam ortaklıkları kurun.',
    'adTag1': 'Reklam', 'adTag2': 'Gelir', 'adTag3': 'Pazarlama', 'adTag4': 'Ciro',
    'noChangeTitle': 'HIZLI KURULUM',
    'noChangeSubtitle': 'Altyapı Değişikliği Gerektirmez',
    'noChangeDesc': 'Mevcut sisteminizle uyumlu çalışır, dakikalar içinde aktif edilir.',
    'noChangeFooter': 'En kolay dijitalleşme yolu.',
    'pricingBadge': 'FİYATLANDIRMA',
    'pricingTitle': 'Şeffaf ve Esnek Paketler',
    'devTeamPromise': 'Geliştirici ekibimiz her zaman yanınızda.',
    'annualGift': 'YILLIK ÖDEMEDE 2 AY HEDİYE',
    'planBasicTitle': 'BAŞLANGIÇ',
    'planBasicPrice': '499',
    'planBasicDesc': 'Küçük oteller ve butik yerler için ideal.',
    'planBasicFeat1': 'QR Menü Sistemi',
    'planBasicFeat2': 'Sipariş Yönetimi',
    'planBasicFeat3': 'E-posta Desteği',
    'planProTitle': 'PROFESYONEL',
    'planProPrice': '999',
    'planProDesc': 'Büyümeye odaklanan oteller için.',
    'planProFeat1': '9 Dil Desteği',
    'planProFeat2': 'Anket & Geri Bildirim',
    'planProFeat3': 'Öncelikli Destek',
    'planEntTitle': 'KURUMSAL',
    'planEntPrice': 'Özel',
    'planEntDesc': 'Büyük otel zincirleri için tam çözüm.',
    'planEntFeat1': 'Çoklu Şube Yönetimi',
    'planEntFeat2': 'API Entegrasyonu',
    'planEntFeat3': 'Özel Müşteri Temsilcisi',
    'branchDiscountNote': 'Şube sayısına göre özel indirimler.',
    'refundNote': '14 Gün Para İade Garantisi',
    'roiTitle': 'Yatırım Getirisi (ROI)',
    'roiGrowth': '+%25',
    'roiGrowthSub': 'GELİR ARTIŞI',
    'roiEfficiency': '%40',
    'roiEfficiencySub': 'VERİMLİLİK',
    'roiNote': 'Sistem maliyetini ilk aydan amorti eder.',
    'instantSetupTitle': '15 Dakikada Kurulum',
    'instantSetupDesc': 'Menünüzü yükleyin, QR kodları basın ve hemen hizmete başlayın.',
    'referralProgramTitle': 'REFERANS PROGRAMI',
    'referralPromoLine': 'Bizi Önerin, Kazanın!',
    'referralProgramDesc': 'RestXQr\'ı önerdiğiniz her otel için indirimler kazanın.',
    'referralFaqQ': 'Referans programı nasıl çalışır?',
    'referralFaqA': 'Sisteme dahil ettiğiniz her yeni müşteri için bir sonraki ay ödemenizden indirim alırsınız.',
    'faq': 'S.S.S',
    'faqDesc': 'Sıkça sorulan sorular ve cevapları.',
    'faq1Q': 'Sistem nasıl çalışır?',
    'faq1A': 'Misafirleriniz masadaki QR kodu tarayarak menüye ulaşır ve sipariş verir.',
    'faq2Q': 'Kurulum ne kadar sürer?',
    'faq2A': 'Sadece 15 dakika içinde menünüzü yükleyebilir ve kullanmaya başlayabilirsiniz.',
    'faq3Q': 'Güvenli mi?',
    'faq3A': 'Evet, tüm verileriniz endüstri standartlarında şifrelenir.',
    'faq4Q': 'Hangi dilleri destekliyor?',
    'faq4A': 'Türkçe, İngilizce, Almanca ve 6 diğer dili destekliyoruz.',
    'faq5Q': 'Destek veriyor musunuz?',
    'faq5A': 'Evet, 7/24 teknik destek ekibimiz mevcuttur.',
    'faq6Q': 'İptal edebilir miyim?',
    'faq6A': 'Evet, dilediğiniz zaman üyeliğinizi iptal edebilirsiniz.',
    'faq7Q': 'Menü güncelleme kolay mı?',
    'faq7A': 'Evet, kontrol panelinden tek tıkla fiyat ve ürün güncelleyebilirsiniz.',
    'faq8Q': 'Raporlama var mı?',
    'faq8A': 'Evet, detaylı satış ve misafir analiz raporları sunuyoruz.',
    'contactUs': 'İLETİŞİM',
    'footerSlogan': 'Oteller için yeni nesil dijital çözüm ortağınız.',
  ...
  en: {
    ...
    // Premium Landing Page
    'metaTitle': 'RoomXQR - Hotel Digital Transformation',
    'heroBadge': 'NEW GENERATION HOTEL SOLUTION',
    'heroTitle1': 'Digital Transformation',
    'heroTitle2': 'at Your Hotel',
    'heroTitle3': 'Instant Service via QR',
    'heroSubtitle1': 'Boost guest satisfaction and efficiency with RoomXQR.',
    'heroSubtitle2': 'QR menu, ordering, requests, and smart management in one platform.',
    'requestDemo': 'Request Demo',
    'startNow': 'Start Now',
    'premiumServicesBadge': 'PREMIUM FEATURES',
    'premiumServices': 'Powerful Features for Modern Hotels',
    'qrMenuSystem': 'QR Menu & Ordering',
    'orderManagement': 'Order Management',
    'aiTitle': 'AI Powered Images',
    'detailedReporting': 'Detailed Analytics',
    'multiLangTitle': '9+ Language Support',
    'marketingAdsTitle': 'Marketing & Ads',
    'allInOneTitle': 'All-in-One Dashboard',
    'support247': '24/7 Premium Support',
    'valPropDigital': 'Full digital workflow',
    'valPropSpeed': '60% faster service',
    'valPropSatisfy': 'Happy guests',
    'valPropProfit': 'Increased revenue & profit',
    'valPropTrust': 'Reliable infrastructure',
    'adIncomeTitle': 'EXTRA INCOME OPPORTUNITY',
    'caseStudyBadge': 'SUCCESS STORIES',
    'customersSuccessTitle': 'Perfect Experience for Your Guests',
    'customersSuccessDesc': 'Hotels using RoomXQR see a 45% increase in satisfaction and 40% reduction in staff workload.',
    'valPropStaff': 'Efficient Staff',
    'examineFeature': 'Examine Features',
    'satisfiedClientsLabel': 'HAPPY GUESTS',
    'averageGrowthLabel': 'AVERAGE GROWTH',
    'marketingSectionTitle': 'Marketing & Sales Power',
    'learnMore': 'Learn More',
    'kitchenStatTitle': 'Kitchen Integration',
    'kitchenStatDesc': 'Orders go straight to the kitchen, zero errors.',
    'splitPaymentTitle': 'Fast Payment Solutions',
    'splitPaymentDesc': 'Guests can pay easily or charge to their room.',
    'socialGrowthTitle': 'Social Media Growth',
    'socialGrowthDesc': 'Boost TripAdvisor and Google ratings with post-stay surveys.',
    'multiBranchTitle': 'Multi-Branch Management',
    'multiBranchDesc': 'Manage all your hotels from one central dashboard.',
    'aiDesc': 'Automatically optimize your menus with AI.',
    'mgmtControlTitle': 'MANAGEMENT & CONTROL',
    'mgmtTitle': 'Easy to Use, Full Control',
    'mgmtNoTechRequired': 'No technical knowledge needed, start immediately.',
    'mgmtMenuUpdate': 'Instant Menu Updates',
    'mgmtStockHide': 'Hide Out-of-Stock Items',
    'mgmtCampaignDrive': 'Campaign Management',
    'mgmtAnnounceDirect': 'Instant Announcements',
    'waiterCallMainTitle': 'WAITER CALL',
    'waiterCallTitle': 'Call a Waiter with One Click',
    'waiterCallDesc': 'Guests can call a waiter to their table/room whenever they need.',
    'waiterCallFooter': 'Take your service quality to the top.',
    'zeroErrorSectionTitle': 'ZERO ERROR POLICY',
    'qrToKitchenTitle': 'Seamless QR to Kitchen',
    'qrToKitchenDesc': 'Orders transferred directly without manual errors.',
    'zeroErrorList1': 'Fast Scan',
    'zeroErrorList2': 'Right Pick',
    'zeroErrorList3': 'Instant Send',
    'zeroErrorList4': 'Fast Service',
    'passiveIncomeLabel': 'PASSIVE INCOME',
    'premiumSpaceLabel': 'PREMIUM ADS',
    'adIncomeSubtitle': 'Extra Revenue with Ad Spaces',
    'adIncomeDesc': 'Set up ad partnerships inside the menu for extra revenue.',
    'adTag1': 'Ads', 'adTag2': 'Revenue', 'adTag3': 'Marketing', 'adTag4': 'Profit',
    'noChangeTitle': 'FAST SETUP',
    'noChangeSubtitle': 'No Infrastructure Change Needed',
    'noChangeDesc': 'Works with your existing system, active in minutes.',
    'noChangeFooter': 'The easiest way to go digital.',
    'pricingBadge': 'PRICING',
    'pricingTitle': 'Transparent and Flexible Plans',
    'devTeamPromise': 'Our development team is always with you.',
    'annualGift': '2 MONTHS FREE ON ANNUAL PAYMENT',
    'planBasicTitle': 'BASIC',
    'planBasicPrice': '499',
    'planBasicDesc': 'Ideal for small hotels and boutique places.',
    'planBasicFeat1': 'QR Menu System',
    'planBasicFeat2': 'Order Management',
    'planBasicFeat3': 'Email Support',
    'planProTitle': 'PRO',
    'planProPrice': '999',
    'planProDesc': 'For hotels focused on growth.',
    'planProFeat1': '9 Language Support',
    'planProFeat2': 'Surveys & Feedback',
    'planProFeat3': 'Priority Support',
    'planEntTitle': 'ENTERPRISE',
    'planEntPrice': 'Custom',
    'planEntDesc': 'Full solution for large hotel chains.',
    'planEntFeat1': 'Multi-Branch Management',
    'planEntFeat2': 'API Integration',
    'planEntFeat3': 'Dedicated Manager',
    'branchDiscountNote': 'Special discounts for multiple branches.',
    'refundNote': '14-Day Money Back Guarantee',
    'roiTitle': 'Return on Investment (ROI)',
    'roiGrowth': '+25%',
    'roiGrowthSub': 'REVENUE GROWTH',
    'roiEfficiency': '40%',
    'roiEfficiencySub': 'EFFICIENCY',
    'roiNote': 'System pays for itself from the first month.',
    'instantSetupTitle': 'Setup in 15 Minutes',
    'instantSetupDesc': 'Upload your menu, print QR codes, and start serving.',
    'referralProgramTitle': 'REFERRAL PROGRAM',
    'referralPromoLine': 'Recommend Us, Earn!',
    'referralProgramDesc': 'Earn discounts for every hotel you recommend.',
    'referralFaqQ': 'How does it work?',
    'referralFaqA': 'Get discounts on your next month for every new client you bring.',
    'faq': 'FAQ',
    'faqDesc': 'Frequently asked questions and answers.',
    'faq1Q': 'How does the system work?',
    'faq1A': 'Guests scan the QR code to see the menu and place orders.',
    'faq2Q': 'How long is the setup?',
    'faq2A': 'You can be ready in just 15 minutes.',
    'faq3Q': 'Is it secure?',
    'faq3A': 'Yes, all data is encrypted to industry standards.',
    'faq4Q': 'Which languages are supported?',
    'faq4A': 'TR, EN, DE and 6 more.',
    'faq5Q': 'Do you provide support?',
    'faq5A': 'Yes, 24/7 technical support is available.',
    'faq6Q': 'Can I cancel?',
    'faq6A': 'Yes, you can cancel your subscription any time.',
    'faq7Q': 'Is it easy to update?',
    'faq7A': 'Yes, update prices and products with one click.',
    'faq8Q': 'Is there reporting?',
    'faq8A': 'Yes, we provide detailed growth analytics.',
    'contactUs': 'CONTACT',
    'footerSlogan': 'Your new generation digital partner for hotels.',
